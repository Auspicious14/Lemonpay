...
export default function WelcomeSlide() {
  ...
  return (
    <OnboardingSlide
      ...
      description="The guardian of your digital commerce. We hold funds in a lympay vault until every promise is kept, ensuring absolute transparency in every transaction."
          ...
          >
            ...
            <View>
              ...
              <Typography variant="label-sm" className="!text-secondary">
                Secured by the LymPay Sentinel Protocol
              </Typography>
            </View>
          </Card>
        </View>
